...
% SWIFocusX = -32*1.8869; % L8-4用这个
SWIFocusX = [-30,30];  %L7-3用这个
SWIFocusZ = [40,50,60,70,80];  % L8-4 波长0.2655mm,L7-3 波长0.2962mm
SWIROI.width = 100; 
...
SeqControl(6).argument = 150;               % 100usec
PRF=6;
% - time between frames
SeqControl(7).command = 'timeToNextEB';    % set time between extended bursts
SeqControl(7).argument = 1000000;            % 1000000usec = 1000msec (~ 5 fps)
TTNEB=7;
